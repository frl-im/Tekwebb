...
<div class="form-header">
    <h1><i class="fas fa-edit me-3"></i>Edit Data Mahasiswa</h1>
...
<div class="form-card">
    <div class="form-info-box">
        ...
        Perbarui data yang diperlukan dan simpan perubahan
    </div>
    ...
    <form action="/editdata/{{ $data['id'] }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="nama" value="{{ $data->name }}" placeholder="Masukkan nama lengkap" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nim" id="nim" value="{{ $data->nim }}" placeholder="Contoh: 12345678" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="prodi" id="prodi" value="{{ $data->prodi }}" placeholder="Contoh: Teknik Informatika" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" id="email" value="{{ $data->email }}" placeholder="contoh@email.com" class="form-control" required>
        ...
        <div class="form-group">
            ...
            <input type="tel" name="nohp" id="nohp" value="{{ $data->nohp }}" placeholder="Contoh: 081234567890" class="form-control" required>
